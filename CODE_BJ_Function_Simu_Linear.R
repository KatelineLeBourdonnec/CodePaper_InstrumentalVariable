...
# This code runs a scenario of simulations for a binary IV with a linear
...
# The logistic first-stage alternative is given in file
...
#The results of this script are output in folder "linear_sub". 
...
job <- 7958158# TO BE CHANGED BY THE USER (if not run on a computing server)
...
res <- list(CoefTrue,CoefTrueInter,sdTrue, sdTrueInter,CoefNaifInter0,CoefNaif0,sdNaif0,sdNaifInter0,Coef2stageM,Coef2stageInter,sd2stageM,sd2stageInter,r2_1,F_1,var_corrig,se_corr,TC,TCint,VarIntra,VarInter,VarTot,VarIntraInt,VarInterInt,VarTotInt,resu[[1]],resu[[2]])

##### Output #####
save(res,file=paste("simu_boots_2000_LINEAR2_",job,"_",rep,".Rdata",sep=""))
